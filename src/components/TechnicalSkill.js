            ...
            <Container>
                <Row className='g-5'>
                    ...
                    <Col md={4}>
                        ...
                        <h2 style={{color:'#54faae',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>C++</h2>
                        </div>
                    </Col>
                    <Col md={4}>
                    ...
                    <Col md={4}>
                        <h1 style={{ fontSize: '100px',color:'#41f2ff',fontWeight:700 }}>78%</h1>
                        <div style={{ paddingLeft: '50px',paddingRight:'50px'}}>
                        <div class="progress">
                            <div role={"progressbar"} id={"react"} aria-valuenow={"86"} aria-valuemin={"0"} aria-valuemax={"100"} style={{width: '86%'}}>
                            </div>
                        </div>
                        <h2 style={{color:'#41f2ff',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>React js</h2>
                        </div>
                    </Col>
                </Row>
            </Container>
